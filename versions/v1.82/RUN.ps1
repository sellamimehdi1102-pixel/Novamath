# NovaMath v1.82 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.82..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.82..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.82 est lance sur $Url"
