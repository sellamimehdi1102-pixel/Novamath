...
echo ============================================
echo   Lancement de NovaMath v1.59...
echo ============================================
echo.
...
echo.
echo Demarrage du serveur NovaMath v1.59...
echo (une nouvelle fenetre va s'ouvrir - laisse-la ouverte)
echo.

start "NovaMath v1.59 - Serveur" cmd /k ""!PYTHON!" webapp\server.py"
...
if !WAITED! geq 30 (
    ...
    echo Regarde la fenetre "NovaMath v1.59 - Serveur" pour le detail de l'erreur.
    echo.
    pause
    exit /b 1
)
...
start "" "%URL%"
echo.
echo NovaMath v1.59 est lance sur %URL%
echo Pour arreter le serveur : ferme la fenetre "NovaMath v1.59 - Serveur".
echo.
pause
