# NovaMath v1.59 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.59..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.59..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.59 est lance sur $Url"
