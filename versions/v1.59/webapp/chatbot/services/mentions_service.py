...
# restent dans la conversation (grounding) ; "nav"/"action" ouvrent une page
# ou déclenchent une action UI — réservé aux cas où il n'y a rien à résumer
# en texte (choisir une série, éditer son profil).
CATEGORIES = [
