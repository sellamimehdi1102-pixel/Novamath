# NovaMath v1.15 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.15..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.15..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.15 est lance sur $Url"
