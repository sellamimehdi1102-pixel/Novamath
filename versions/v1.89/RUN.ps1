# NovaMath v1.89 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.89..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.89..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.89 est lance sur $Url"
