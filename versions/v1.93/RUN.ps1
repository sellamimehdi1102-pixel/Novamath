# NovaMath v1.93 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.93..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.93..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.93 est lance sur $Url"
