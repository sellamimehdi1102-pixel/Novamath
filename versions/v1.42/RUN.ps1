# NovaMath v1.42 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.42..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.42..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.42 est lance sur $Url"
