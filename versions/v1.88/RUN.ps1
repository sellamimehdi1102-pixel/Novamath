# NovaMath v1.88 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.88..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.88..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.88 est lance sur $Url"
