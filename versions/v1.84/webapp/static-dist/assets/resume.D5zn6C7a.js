import{e as g}from"./i18n.k284iSwh.js";import{i as o}from"./theme.3Ba6cpxV.js";function f(t){return t<60?`${t} s`:`${Math.round(t/60)} min`}function u(t){var s,n;const e=g();if(!e)return t.hidden=!0,!1;const a=(e.draftQuestions||[]).reduce((d,c)=>d+(c.duration_s||0),0),i=((s=e.seriesConfig)==null?void 0:s.chapterId)||"Entraînement mixte",p=((n=e.seriesConfig)==null?void 0:n.notion)||"—",r=e.total||10,l=e.progressPct??Math.round(e.seriesIndex/r*100);return t.hidden=!1,t.innerHTML=`
