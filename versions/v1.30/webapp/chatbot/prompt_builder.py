...
et préférences utilisateur (longueur de réponse, niveau d'explication).
Le Rule Engine / Math Engine / RAG Engine (Phase 2) s'ajouteront comme des
sources supplémentaires de contexte ici, sans changer la façon dont le
Provider Manager consomme system+messages.
"""
...
def build_system_prompt(user, chatbot_settings, chapters_summary=None):
