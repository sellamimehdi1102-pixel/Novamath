...
DEFAULT_SETTINGS = {
    ...
    "favorites": [],
    # Chatbot pédagogique (voir webapp/chatbot/) — un seul fournisseur réel
    # pour l'instant (Claude), le reste de la structure est prêt pour en
    # accueillir d'autres (provider_manager.py) sans migration de schéma.
    "chatbot": {
        "provider": "anthropic",
