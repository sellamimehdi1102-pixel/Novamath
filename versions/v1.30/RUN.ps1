# NovaMath v1.30 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.30..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.30..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.30 est lance sur $Url"
