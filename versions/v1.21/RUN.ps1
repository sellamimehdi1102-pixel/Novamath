# NovaMath v1.21 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.21..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.21..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.21 est lance sur $Url"
