...
Flask). Ollama (modèle local Mistral par défaut) est le fournisseur par
défaut de NovaMath : aucune API cloud n'est appelée tant qu'il n'est pas
...
def active_provider_name(override=None):
    return override or os.environ.get("CHATBOT_PROVIDER", "ollama")
