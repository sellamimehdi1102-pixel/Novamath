...
// ── Santé du fournisseur IA (Ollama local par défaut) ───────────────────────
async function checkProviderHealth() {
  try {
    ...
    if (health.ok) {
      ...
      providerBannerMsg.textContent = health.detail || "Le moteur d'intelligence artificielle local n'est pas démarré.";
      providerBanner.hidden = false;
    }
  } catch {
