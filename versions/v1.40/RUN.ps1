# NovaMath v1.40 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.40..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.40..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.40 est lance sur $Url"
