...
from .services import action_cards_service, mentions_service, search_service
...
def stream_reply(user, conversation_id, user_message, chapters_summary=None, mentions=None):
    ...
    mentions_block = mentions_service.build_grounding_block(mentions)
    system_prompt = build_system_prompt(user, chatbot_settings, chapters_summary, rag_context, mentions_block)
...
def regenerate_last(user, conversation_id, chapters_summary=None):
    ...
    mentions_block = mentions_service.build_grounding_block(last_user.get("mentions"))
    system_prompt = build_system_prompt(user, chatbot_settings, chapters_summary, rag_context, mentions_block)
