# NovaMath v1.51 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.51..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.51..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.51 est lance sur $Url"
