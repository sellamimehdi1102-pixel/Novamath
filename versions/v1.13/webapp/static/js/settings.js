...
const HELP_PAGES = {
  ...
  fonctionnement: {
    ...
    body: `
      ...
      <p><strong>2. Entraînement ciblé.</strong> Depuis Chapitres ou Entraînement, tu lances des séries d'exercices dont le nombre, le chronomètre et le comportement suivent tes préférences définies dans Paramètres → Entraînement — quel que soit l'endroit d'où tu les lances.</p>
  ...
  guide: {
    ...
    body: `
      <p><strong>Démarrer une série</strong> — depuis Entraînement, choisis un mode (Révisions, Objectif du jour, Examen blanc, Défi chronométré, Erreurs précédentes) puis lance-la. Depuis Chapitres, sélectionne un chapitre ou une notion précise.</p>
