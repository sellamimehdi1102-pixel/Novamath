# NovaMath v1.13 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.13..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.13..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.13 est lance sur $Url"
