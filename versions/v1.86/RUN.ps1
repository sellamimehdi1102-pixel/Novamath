# NovaMath v1.86 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.86..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.86..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.86 est lance sur $Url"
