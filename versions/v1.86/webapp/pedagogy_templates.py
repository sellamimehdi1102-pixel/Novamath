...
_CATEGORY_RULES = (
    ...
    ("suites", r"suite|limite d.une suite|somme de|calcul de sommes"),
    ...
    ("statistiques", r"moyenne|ecart.type|quartile"),
    ...
    ("intervalles", r"intervalle|inegalite|comparaison|valeur absolue"),
