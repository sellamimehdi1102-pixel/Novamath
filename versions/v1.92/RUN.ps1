# NovaMath v1.92 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.92..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.92..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.92 est lance sur $Url"
