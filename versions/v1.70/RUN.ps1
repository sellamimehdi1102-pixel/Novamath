# NovaMath v1.70 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.70..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.70..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.70 est lance sur $Url"
