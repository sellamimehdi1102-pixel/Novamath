...
def _detect_chapter(text, context_summary, class_level=None):
    ...
    matches = search_service.search(text, scope=[search_service.SCOPE_COURS], limit=1, class_level=class_level)
...
def classify(user_message, context_summary=None, class_level=None):
    ...
    chapter_id, notion_id = _detect_chapter(topic_text, context_summary, class_level=class_level)
    return {
        "intent": intent,
