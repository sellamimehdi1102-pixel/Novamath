# NovaMath v1.91 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.91..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.91..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.91 est lance sur $Url"
