import{a as P}from"./api.DlOwEDsY.js";import"./scroll-reveal.C-UvXuVT.js";/* empty css             *//* empty css              */import{r as H}from"./chapterTitleByNotions.B33dvngo.js";import"./sidebar.KwnHgx5Y.js";import"./command-palette.Cpe_rG6b.js";import{i as J,b as V,s as K,g as U,c as X,m as Y,a as Z,d as Q,e as W,f as D,h as ee,j as te}from"./i18n.DL1tH7oD.js";import{b as se}from"./settingsPopup.Brn01din.js";import{r as ne}from"./resume.C4kcyu5f.js";import{g as h,i as f}from"./theme.3Ba6cpxV.js";const T=J();T.then(()=>V());se(document.getElementById("settings-btn"));ne(document.getElementById("resume-card"));const q={1:"Facile",2:"Moyen",3:"Confirmé",4:"Difficile",5:"Expert"},j={1:"badge--success",2:"badge--success",3:"badge--warning",4:"badge--danger",5:"badge--danger"},m=new Set,g=document.getElementById("chapters-grid"),N=document.getElementById("selection-bar"),re=document.getElementById("selection-count"),F=document.getElementById("chapters-empty-filter");let C=[],w="all";const ae=2;let R=!1;P.me().then(({user:e})=>{R=!!e.is_guest}).catch(()=>{});function oe(){if(document.getElementById("guest-chapters-modal-overlay"))return;const e=document.createElement("div");e.className="modal-overlay",e.id="guest-chapters-modal-overlay",e.hidden=!0,e.innerHTML=`
