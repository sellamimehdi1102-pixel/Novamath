# NovaMath v1.85 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.85..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.85..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.85 est lance sur $Url"
