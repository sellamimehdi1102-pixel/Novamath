# NovaMath v1.87 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.87..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.87..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.87 est lance sur $Url"
