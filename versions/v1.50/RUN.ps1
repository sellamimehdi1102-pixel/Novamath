# NovaMath v1.50 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.50..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.50..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.50 est lance sur $Url"
