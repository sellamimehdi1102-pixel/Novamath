# NovaMath v1.22 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.22..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.22..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.22 est lance sur $Url"
