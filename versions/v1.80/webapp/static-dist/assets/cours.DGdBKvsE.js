import{a as y}from"./api.CC07HWUE.js";import"./scroll-reveal.C-UvXuVT.js";/* empty css             *//* empty css              */import{r as T}from"./chapterTitleByNotions.B33dvngo.js";/* empty css                 */import"./sidebar.D040TCdL.js";import"./command-palette.Cx5xRZsE.js";import{i as Q,b as Z,l as J}from"./i18n.ja2ECFcd.js";import{b as X}from"./settingsPopup.Dz82AKxx.js";import{g as C,f as W,i as l,I as Y}from"./theme.BLPjMu9D.js";import{a as R}from"./mathrender.C9lrWfgK.js";import{f as q}from"./animations.C6n5EluG.js";const k=28,x=260;function p(e,s,t){const[n,r,o,i]=e.viewBox,a=(x-2*k)/Math.max(o,i),d=k+(s-n)*a,u=x-k-(t-r)*a;return[d,u]}function $(e,s){if(typeof s=="string"){const t=(e.points||[]).find(n=>n.label===s);return t?[t.x,t.y]:[0,0]}return[s.x,s.y]}function K(e){const[s,t,n,r]=e.viewBox;let o="";for(let i=Math.ceil(s);i<=s+n;i++){const[a,d]=p(e,i,t),[u,g]=p(e,i,t+r);o+=`<line x1="${a}" y1="${d}" x2="${u}" y2="${g}" class="geom-grid-line"/>`}for(let i=Math.ceil(t);i<=t+r;i++){const[a,d]=p(e,s,i),[u,g]=p(e,s+n,i);o+=`<line x1="${a}" y1="${d}" x2="${u}" y2="${g}" class="geom-grid-line"/>`}return o}function ee(e){const[s,t,n,r]=e.viewBox;if(s>0||s+n<0||t>0||t+r<0)return"";const[o,i]=p(e,s,0),[a,d]=p(e,s+n,0),[u,g]=p(e,0,t),[f,w]=p(e,0,t+r);return`
