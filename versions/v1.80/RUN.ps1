# NovaMath v1.80 - Lancement (PowerShell)
...
Write-Host "============================================"
Write-Host "  Lancement de NovaMath v1.80..."
Write-Host "============================================"
Write-Host ""
...
Write-Host ""
Write-Host "Demarrage du serveur NovaMath v1.80..."
...
Start-Process $Url
Write-Host ""
Write-Host "NovaMath v1.80 est lance sur $Url"
