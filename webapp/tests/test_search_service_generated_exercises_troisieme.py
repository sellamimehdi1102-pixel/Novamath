...
diversification, lot 2026-08 — pendant de
...
8 modules déclarés (equation_premier_degre/divisibilite/fractions_addition/
fractions_simplification/fonction_affine_deux_points/
developper_distributivite/factoriser_somme/image_fonction — voir
tools/generate_troisieme_exercises.py), chacun avec son propre
GENERATED_ID_OFFSET (100_000 à 170_000), couvrant Chapitre_1/3/4/5/7/8.
"""
import unittest
...
GENERATED_ID_CEILING = 200_000  # borne haute exclusive : distincte des offsets Première (900_000+)
...
class TestExercicesGeneresTroisiemeVisiblesParLeChatbot(unittest.TestCase):
    def test_load_exercise_documents_inclut_le_pool_genere(self):
        ...
        self.assertEqual(chapters, {"Chapitre_1", "Chapitre_3", "Chapitre_4", "Chapitre_5", "Chapitre_7", "Chapitre_8"})
