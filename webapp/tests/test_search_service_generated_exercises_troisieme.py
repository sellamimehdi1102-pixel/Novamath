...
diversification, lot 2026-08, étendu par la mission "rééquilibrage global de
toutes les classes" 2026-09-01 — pendant de
test_search_service_generated_exercises.py pour Première) : le pool produit
par webapp/exercise_generator_troisieme/ (fusionné dans server.py::_class_bank
pour le mode Exercices du site, via curriculum_registry.CurriculumProfile
"troisieme".generated_exercise_bank) doit aussi être visible par
chatbot/services/search_service.py.

13 modules déclarés (equation_premier_degre/divisibilite/fractions_addition/
...
proportionnalite/statistiques/probabilites_troisieme/thales — voir
tools/generate_troisieme_exercises.py), chacun avec son propre
GENERATED_ID_OFFSET (100_000 à 220_000), couvrant Chapitre_1 à Chapitre_10 et
Chapitre_14.
"""
import unittest
...
GENERATED_ID_CEILING = 230_000  # borne haute exclusive : distincte des offsets Première (900_000+)
...
class TestExercicesGeneresTroisiemeVisiblesParLeChatbot(unittest.TestCase):
    def test_load_exercise_documents_inclut_le_pool_genere(self):
        ...
        self.assertEqual(chapters, {
            ...
            "Chapitre_6", "Chapitre_7", "Chapitre_8", "Chapitre_9", "Chapitre_10", "Chapitre_14",
        })
